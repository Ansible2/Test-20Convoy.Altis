/* ----------------------------------------------------------------------------
Function: KISKA_fnc_convoyAdvanced_getVehicleDebugFollowedPath
...
Examples:
    (begin example)
        private _debugFollowedPathObjects = [
            _vehicle
        ] call KISKA_fnc_convoyAdvanced_getVehicleDebugFollowedPath;
    (end)

Author(s):
    Ansible2
---------------------------------------------------------------------------- */
scriptName "KISKA_fnc_convoyAdvanced_getVehicleDebugFollowedPath";
...
_vehicle getVariable ["KISKA_convoyAdvanced_debug_followedPathObjects",[]]
