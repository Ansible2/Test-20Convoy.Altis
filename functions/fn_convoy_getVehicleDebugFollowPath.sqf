/* ----------------------------------------------------------------------------
Function: KISKA_TEST_fnc_convoy_getVehicleDebugFollowPath
...
Examples:
    (begin example)
        private _debugFollowPathObjects = [
            _vehicle
        ] call KISKA_TEST_fnc_convoy_getVehicleDebugFollowPath;
    (end)

Author(s):
    Ansible2
---------------------------------------------------------------------------- */
scriptName "KISKA_TEST_fnc_convoy_getVehicleDebugFollowPath";
