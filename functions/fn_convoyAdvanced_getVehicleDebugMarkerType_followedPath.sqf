/* ----------------------------------------------------------------------------
Function: KISKA_fnc_convoyAdvanced_getVehicleDebugMarkerType_followedPath
...
Examples:
    (begin example)
        private _followedPathMarkerType = [
            _vehicle
        ] call KISKA_fnc_convoyAdvanced_getVehicleDebugMarkerType_followedPath;
    (end)

Author(s):
    Ansible2
---------------------------------------------------------------------------- */
scriptName "KISKA_fnc_convoyAdvanced_getVehicleDebugMarkerType_followedPath";
