/* ----------------------------------------------------------------------------
Function: KISKA_fnc_convoyAdvanced_modifyVehicleDrivePath
...
Author(s):
    Ansible2
---------------------------------------------------------------------------- */
scriptName "KISKA_fnc_convoyAdvanced_modifyVehicleDrivePath";
...
private _vehicleDrivePath = [_vehicle] call KISKA_fnc_convoyAdvanced_getVehicleDrivePath;
