/* ----------------------------------------------------------------------------
Function: KISKA_fnc_convoyAdvanced_setVehicleDebugMarkerType_followedPath
...
Examples:
    (begin example)
        ...
        ] call KISKA_fnc_convoyAdvanced_setVehicleDebugMarkerType_followedPath;
    (end)

Author(s):
    Ansible2
---------------------------------------------------------------------------- */
scriptName "KISKA_fnc_convoyAdvanced_setVehicleDebugMarkerType_followedPath";
...
_vehicle setVariable ["KISKA_convoyAdvanced_debugMarkerType_followedPath",_type];
