/* ----------------------------------------------------------------------------
Function: KISKA_fnc_convoyAdvanced_clearVehicleDebugFollowedPath
...
Examples:
    (begin example)
		[_vehicle] call KISKA_fnc_convoyAdvanced_clearVehicleDebugFollowedPath;
    (end)

Author(s):
    Ansible2
---------------------------------------------------------------------------- */
scriptName "KISKA_fnc_convoyAdvanced_clearVehicleDebugFollowedPath";
...
if (_deleteExisting) then {
    ([_vehicle] call KISKA_fnc_convoyAdvanced_getVehicleDebugFollowedPath) apply {
        deleteVehicle _x;
    };
};
